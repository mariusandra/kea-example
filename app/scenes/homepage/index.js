    ...
    return (
      <div className='homepage-scene'>
        ...
        <div className='description'>
          <p><strong>NB!</strong> This documentation is for the 1.0 release. To see docs for 0.28, <a href='https://5d7a15398fdb1e00073ed27f--kea-v1.netlify.com/'>click here</a>.</p>
          <p>To see the docs for 2.0, <a href='https://kea.js.org'>click here</a>.</p>
        </div>
        <h2>Why Kea?</h2>
        <div className='description'>
          <p>
